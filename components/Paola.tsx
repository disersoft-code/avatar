...
import AudioTexto1 from "../assets/audios/audio3.json";
...
export function Paola(props: JSX.IntrinsicElements["group"]) {
    const group = useRef<THREE.Group>(null);
    const { nodes, materials } = useGLTF(
        require("../assets/models/Paola.glb")
    ) as GLTFResult;
    const { animations } = useGLTF(
        require("../assets/animations/animations_paola.glb")
    ) as GLTFResult2;
    ...
    useEffect(() => {
        if (isAudioEnd) {
            ...
            changeAnimation(ANIMATIONS.STANDING);
            if (
